...
{رانش آلل}{رانش آلل‌ها}
\newword{allelecdropout}{Allelec dropout}
{رانش آللی}{رانش‌های آللی}
...
\newword{backpropagate}{Back-propagate}
{بک‌پروپگیت}{بک‌پروپگیت}
...
\newword{death}{Death}
{‌مرگ‌}{‌‌مرگ}
\newword{distinguish}{Distinguish}
{تمیز دادن}{تمیز دادن}
...
\newword{deepqlearning}{Deep Q-learning}
...
\newword{delineate}{Delineate}
{ترسیم کردن}{ترسیم کردن}
...
{ناهمگن}{ناهمگن}
\newword{heterozygous}{Heterozygous}
{هتروزیگوت}{هتروزیگوت}
...
\newword{latentspace}{Latent space}
{فضای لیتنت}{فضاهای لیتنت}
...
\newword{mdp}{Markov decision process}
{فرآیند تصمیم مارکوف}{فرآیندهای تصمیمات مارکوف}
...
{یادگیری با ناظر}{یادگیری با ناظر}
\newword{stochasticgradientdescent}{Stochastic gradient descent}
{گرادیان نزولی تصادفی}{گرادیان نزولی تصادفی}
\newword{temporaldifference}{Temporal Difference}
{تفاضل زمانی}{تفاضل زمانی}
...
\newword{transcriptome}{Transcriptome}
{ترنسکریپتوم}{ترنسکریپتوم‌ها}
\newword{uniform}{Uniform}
{یکنواخت}{یکنواخت}
\newword{unsupervised}{Unsupervised}
{بدون ناظر}{بدون ناظر}
