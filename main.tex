...
\include{./tex/chaps/rw/chap-rw}		% فصل روش‌های پیشین

%\include{./tex/chapter3}		% فصل سوم: روش تحقیق
\include{./tex/chaps/pm/chap-pm}		% فصل روش پیشنهادی

%\include{./tex/chapter4}		% فصل چهارم: نتایج تجربی
\include{./tex/chaps/er/chap-er}		% فصل نتایج تجربی 

%\include{./tex/chapter5}		% فصل پنجم: بحث و نتیجه‌گیری
\include{./tex/chaps/con/chap-con}		% فصل بحث و نتیجه‌گیری 
...
%\include{./tex/appx/appendix1}		% پیوست اول: آشنایی مقدماتی با لاتک
%\include{./tex/appx/appendix2}		% پیوست دوم: جدول، نمودار و الگوریتم در لاتک
%\include{./tex/appx/appendix3}   	% پیوست سوم: مراجع، واژه‌نامه و حاشیه‌نویسی
