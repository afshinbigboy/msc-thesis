...
\include{./tex/chaps/int/chap-int}		    % فصل اول: مقدمه
\include{./tex/chaps/lr/chap-lr}		    % فصول دوم: ادبیات موضوعی
\include{./tex/chaps/rw/chap-rw}		% فصل سوم: روش‌های پیشین
\include{./tex/chaps/pm/chap-pm}	% فصل چهارم: روش پیشنهادی
\include{./tex/chaps/er/chap-er}	     % فصل پنجم: نتایج تجربی 
\include{./tex/chaps/con/chap-con}		% فصل ششم: بحث و نتیجه‌گیری 
...
%\include{./tex/appxs/appendix1}		% پیوست اول: آشنایی مقدماتی با لاتک
%\include{./tex/appxs/appendix2}		% پیوست دوم: جدول، نمودار و الگوریتم در لاتک
%\include{./tex/appxs/appendix3}   	% پیوست سوم: مراجع، واژه‌نامه و حاشیه‌نویسی
\include{./tex/appxs/app_td3}		% پیوست اول: آشنایی مقدماتی با لاتک
\include{./tex/appxs/app_cnn}
\include{./tex/appxs/app_lstm}
